...
?>
	...
	<head>
		<!-- Start WOWSlider.com HEAD section -->
			<link rel="stylesheet" type="text/css" href="<?php echo "$statics_path"; ?>/wow/engine1/style.css" />
			<script type="text/javascript" src="<?php echo "$statics_path"; ?>/wow/engine1/jquery.js"></script>
