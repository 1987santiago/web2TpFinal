...
<div>
	<h2 class="reserva">Abone su reserva </h2>
		<form class="contact_form" action ="<?php echo "$static_url"; ?>/components/registroPagoReserva.php" method="post" >
			<ul>
  				...
  				<li>
  					<label>Confirme Monto a Abonar <span>(*)</span></label>
          ...
          <label><span>(*) Dato Obligatorio</span></label> 
			</ul>
		</form>
